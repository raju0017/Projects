...
<script>
		...
		function getCityServices(){
			...
			var x=(document.getElementById("cityDD").value);
		
		 	urlStr = "/AtYourHome/getCityServices.html?cityId="+document.getElementById("cityDD").value;
	        $.ajax({url: urlStr, success: function(result) {
	           // alert(result);
	      		var data=$("#servicesDD").html(result);
	      		//alert("ghjg"+data);
		...
		function Cityddl(){
			var cityname= document.getElementById("cityddlId").text;
			//alert("cityname is: "+cityname);
			 document.getElementById("cityconvertId").value=cityname;

			 var servicename=document.getElementById("servicesDD1").text;

			 alert("servicename is: "+servicename);	
			
			 document.getElementById("serviceconvertId").value=servicename;
			
			 
			 
			 //alert("hgj"+ document.getElementById("serviceconvertId").text);
			/* alert("fgh"+document.getElementByAttribute("services"));
				var servicename= document.getElementById("serviceId").text;
...
function getSubService(){
			...
			var x=(document.getElementById("servicesDD").value);
			//alert(x);
...
<body bgcolor="#FDF5E6" onload="noBack();" onpageshow="if (event.persisted) noBack();"
	onunload="">
	<center>
		<h1>Welcome To Home Service</h1>

		<form id="myform" name="myform" method="post" action="save.html">
			<div 
		...
		<a href="logout.html">LogOut</a>
			...
			<select name="address1" id="cityDD" onchange="getCityServices();">
				<option value="">Select Your City</option>
				<c:forEach items="${citys}" var="city">
					<option id="cityddlId" value="${city.ct_id}">${city.ct_name}</option>
				</c:forEach>
			</select> <br><br><br><select name="sericess" id="servicesDD" onchange="getSubService()">
				<option value="">Select Required Service</option>
				<c:forEach items="${sericess}" var="serices">
					<option id="servicesDD1" value="${service.serv_id}">${service.serv_desc}</option>
				</c:forEach>
			</select><br><br><br>
			<tr>
				<td><select name="subService" id="sub_serv_id">
						...
						<option value="">Select Required Sub Service</option>
							<option value="${subService.sub_serv_id}">${subService.sub_serv_desc}</option>
						</core:forEach>
				</select></td>
			</tr>
			<center>
				<br> <input type="submit" value="submit" onclick="Cityddl()">
		</form>
	</center>
	</br>
	</br>
...
<body>
	...
	<form  class="jotform-form" action="save.html" method="post"
		name="form_53431401626446" id="53431401626446" accept-charset="utf-8" style="align:center;" >
