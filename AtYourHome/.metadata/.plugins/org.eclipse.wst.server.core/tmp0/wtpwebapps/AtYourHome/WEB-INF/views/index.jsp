	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li><a href="bpoLogin.html " accesskey="2" title="">BPO</a></li>
				<li><a href="admin.html" accesskey="3" title="">Login As Admin</a></li>
				<li><a href="userlogin.html" accesskey="4" title="">Login As User</a></li>
