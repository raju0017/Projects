...
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.10225" type="text/javascript"></script>
...
function getSubService(){
			...
			obj.open("GET","http://localhost:8000/AtYourHome/getSubService.html?serv_id="+x,true);
			obj.send();
...
<link href="https://cdn.jotfor.ms/static/formCss.css?3.3.10225" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.10225" />
<link type="text/css" media="print" rel="stylesheet" href="https://cdn.jotfor.ms/css/printForm.css?3.3.10225" />
<link type="text/css" rel="stylesheet" href="https://secure.jotform.me/themes/CSS/54a64d6e25d7909c1f8b4567.css?session=47841077132574&themeRevisionID=5628e855977cdf35308b4567"/>
<style type="text/css">
    .form-label-left{
...
.form-all:before {
  content: "";
  background-image: url("//www.santorinipremier.gr/sites/default/files/photo%20bookingbanner.jpg");
  display: inline-block;
  height: 150px;
  position: absolute;
...
<div align="right" style="top:0 " > 
 ...
 <table align="center" >
 <tr><th>Select Service :</th>
 <td><select name="service" id="serv_id" onchange="getSubService()">
...
<form class="jotform-form" action="save.html" method="post" name="form_53431401626446" id="53431401626446" accept-charset="utf-8">
  <input type="hidden" name="formID" value="53431401626446" />
  <div class="form-all">  
    <ul class="form-section page-section">
      <li class="form-line always-hidden" data-type="control_textbox" id="id_11">
        <label class="form-label form-label-top form-label-auto" id="label_11" for="input_11"> ID </label>
        <div id="cid_11" class="form-input-wide always-hidden jf-required">
          <input type="text" class=" form-textbox" data-type="input-textbox" id="input_11" name="sr_id" size="20" value="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_1">
        ...
        <div id="cid_1" class="form-input-wide jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_1" name="sr_desc" size="20" value="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_8">
        ...
        <div id="cid_8" class="form-input-wide jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_8" name="sub_serv_name" size="20" value="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_9">
        ...
        <div id="cid_9" class="form-input-wide jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_9" name="ar_name" size="20" value="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_3">
        ...
        <div id="cid_3" class="form-input-wide jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_3" name="sr_pers_name" size="20" value="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_4">
        <label class="form-label form-label-top form-label-auto" id="label_4" for="input_4">
          Kindly Provide Your Mobile Number
          <span class="form-required">
            *
          </span>
        </label>
        <div id="cid_4" class="form-input-wide jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_4" name="phone" size="12" value="" maxlength="12" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_5">
        ...
        <div id="cid_5" class="form-input-wide jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_5" name="address1" size="20" value="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_6">
        ...
        <div id="cid_6" class="form-input-wide jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_6" name="address2" size="20" value="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_7">
        ...
        <div id="cid_7" class="form-input-wide jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_7" name="email" size="20" value="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_10">
        <label class="form-label form-label-top form-label-auto" id="label_10" for="input_10">
          Service Expecting Date
          <span class="form-required">
            *
          </span>
        </label>
        <div id="cid_10" class="form-input-wide jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_10" name="ep_date" size="20" value="" />
        </div>
      </li>
      <li class="form-line always-hidden" data-type="control_textbox" id="id_12">
        <label class="form-label form-label-top form-label-auto" id="label_12" for="input_12"> RequestedDate </label>
        <div id="cid_12" class="form-input-wide always-hidden jf-required">
          <input type="text" class=" form-textbox" data-type="input-textbox" id="input_12" name="sr_date" size="20" value="NOW()" />
        </div>
      </li>
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="53431401626446" />
  <script type="text/javascript">
